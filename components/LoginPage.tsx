...
const SAMPLE_USERS = [
  {
    ...
    password: 'greenova123',
    role: 'Super Admin'
  },
  {
    username: 'manager',
    email: 'manager@greenova.ai', 
    password: 'manager456',
    role: 'Manager'
  },
  {
    username: 'operator',
    email: 'operator@greenova.ai',
          ...
          <CardContent className="space-y-6">
            ...
            <div className="pt-4 border-t border-border space-y-3">
              ...
              <Button 
                variant="outline" 
                className="w-full"
                onClick={() => window.location.href = 'mailto:admin@greenova.ai?subject=Permintaan Akun Admin GREENOVA'}
              >
            ...
            <div className="pt-4 border-t border-border">
              ...
              {showCredentials && (
                <div className="mt-3 p-3 bg-muted/50 rounded-lg text-xs space-y-2">
                  <p className="font-medium text-center mb-2">Kredensial Demo:</p>
