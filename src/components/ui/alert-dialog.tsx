...
// Mock Radix AlertDialog primitives
const AlertDialogRoot = ({ children, ...props }: any) => <div {...props}>{children}</div>;
const AlertDialogTrigger = React.forwardRef<HTMLButtonElement, any>(({ children, asChild, ...props }, ref) => {
...
const AlertDialogDescription = React.forwardRef<HTMLParagraphElement, any>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
