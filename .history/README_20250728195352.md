...
Ikuti langkah-langkah berikut untuk mengunduh kode proyek dan melihat website Greenova AI di komputer Anda sendiri.
...
Kini, setiap kali Anda atau anggota tim Anda menyimpan perubahan pada file HTML, CSS, atau JavaScript di VS Code, halaman di browser yang dibuka oleh Live Server akan otomatis me-refresh dan menampilkan perubahan terbaru secara instan.

## 🤝 Cara Berkontribusi

(Bagian ini bisa Anda isi nanti dengan pedoman kontribusi tim, seperti membuat branch baru, mengunggah perubahan, dan membuat Pull Request.)
